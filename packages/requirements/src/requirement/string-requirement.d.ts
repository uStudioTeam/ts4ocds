...
export interface StringRequirement extends Requirement {
  ...
  /**
   * Used to state the requirement when the {@link RequirementResponse | response} must be particular string value.
   */
  expectedValue?: string;

  /**
   * A regular expression against which to validate the {@link RequirementResponse | requirement response}.
   */
  pattern?: string;
}
