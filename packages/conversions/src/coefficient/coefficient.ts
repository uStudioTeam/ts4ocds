...
export class Coefficient extends Initializable<Coefficient> {
  ...
  /**
   * Precise value that has to be applied for {@link Conversion | conversion} in specific case.
   */
  public coefficient?: number;

  /**
   * Used to specify a particular {@link Period | period} the {@link Conversion | conversion} and its coefficients are applies to.
   */
