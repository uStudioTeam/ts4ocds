...
export class Search extends Component {
  ...
  private updateResults(): void {
    ...
    for (let i = 0, c = Math.min(10, res.length); i < c; i += 1) {
   ...
   */
  private setLoadingState(value: SearchLoadingState): void {
   ...
   */
  private setCurrentResult(dir: number): void {
